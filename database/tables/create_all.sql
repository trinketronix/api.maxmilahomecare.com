-- GENERATED FILE - do not edit. Source: database/tables/*.sql, database/views/*.sql
-- Regenerate with:  bash database/build.sh
--
-- create_all.sql: creates every table and view (fails if they already exist).
